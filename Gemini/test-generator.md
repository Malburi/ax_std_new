...
| 항목 | 내용 |
|------|------|
| **수신** | (1) 대상 코드 (파일/함수/SQL) (2) `_workspace/impact_<slug>.md` (있으면) (3) `.gemini/patterns/test_pattern.md` (4) 프로젝트 루트 |
...
`.gemini/patterns/test_pattern.md` 읽어 테스트 스타일 파악. 없으면 → pattern-extractor 먼저 호출 권고.
